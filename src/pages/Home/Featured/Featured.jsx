    ...
    return (
        <div className=' featured-item  bg-fixed my-10'>
            ...
            <div className='md:p-10 p-3 text-white'>
                ...
                ></SectionTitle>
                <div className="md:flex justify-centerW items-center max-w-screen-xl mx-auto  px-3  text-white">
                    <div className='md:py-12 md:px-8 '>
                        <img className='rounded-lg h-[350px] md:w-[1000px]' src={featuredImg} alt="" />
                    </div>
